...
const BlogDetails = async ({ id }) => {
	...
	return (
		<div className='bg-white text-black px-8 sm:px-16 md:px-24 lg:px-40 xl:px-50 min-h-[90vh] pb-12'>
			...
			<section>
				<div className='mx-auto w-[80vw] md:w-[60vw] lg:w-[50vw] mt-4 md:mt-12 text-lg text-justify '>
					{blog.content.split('\n').map((i, key) => (
